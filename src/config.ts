...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    defaultProvider: 'https://ws-testnet.hecochain.com',
    deployments: require('./basis-cash/deployments/deployments.hecotestnet.json'),
    externalTokens: {
      DAI: ['0xbeae9dc4dd5ac6214a08d24ab4aca926f41e9a67', 18],
    ...
    baseLaunchDate: new Date('2021-01-23T00:00:00Z'),
    bondLaunchesAt: new Date('2020-01-30T15:00:00Z'),
    boardroomLaunchesAt: new Date('2020-02-08T00:00:00Z'),
